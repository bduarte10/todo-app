  ...
  return (
    <div className="max-w-[736px] w-full bg-gray-500 m-auto border border-gray-400 rounded-lg flex items-center  px-4 py-4 mb-3">
      <button
        ...
        className="w-4 h-4 border border-blue rounded-full flex items-center justify-center hover:bg-blue-dark/20 mr-4">
        {isCompleted ? (
          <span className="w-4 h-4 bg-purple-dark hover:bg-purple rounded-full  flex items-center justify-center">
            <AiOutlineCheck
